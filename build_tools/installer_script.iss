...
OutputBaseFilename=DeadLinkChecker_Setup_v2.0.4_x64
...
UninstallDisplayName=Dead Link Checker v2.0.4
...
Source: "dist\DeadLinkChecker_v2.0.4.exe"; DestDir: "{app}"; DestName: "DeadLinkChecker.exe"; Flags: ignoreversion
...
WelcomeLabel2=This wizard will guide you through the installation of Dead Link Checker v2.0.4.%n%nDead Link Checker is a professional tool for analyzing and reporting broken links on websites. It helps you maintain website quality by identifying dead, broken, or problematic links.%n%nClick Next to continue.
